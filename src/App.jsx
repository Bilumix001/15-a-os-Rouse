        ...
        <div className="info">
          ...
          >
            <Info
              tittle="Confirmación"
              icon="3"
              name="Para confirmar tu asistencia presiona el boton de confirmar y dinos si vendras!!"
              direc="https://docs.google.com/forms/d/e/1FAIpQLScnaXhde9K1JwbbypjF_B43BOrjemZNNYgs9e8eDl1KyJYeNQ/viewform?usp=header"
            />
          </section>
        </div>
